...
const scenes = {
  scene1: {
    ...
    text: 'You arrive at the old estate. Only one window is lit. Inside the hall lies a dusty table and an old diary.',
    ...
    choices: [
      ...
      { text: 'Listen to the radio', next: 'scene2_radio' }
    ]
  },

  scene2_diary: {
    title: 'Elizabeth\'s Diary',
    text: 'The handwriting changes abruptly, as if written in fear...',
    ...
    choices: [
      ...
      { text: 'Go to the East Wing', next: 'scene_east' },
  ...
  scene2_hall: {
    ...
    text: 'Dust, shadows, grand staircase...',
  ...
  scene2_radio: {
    ...
    text: 'A faint voice warns: "...don\'t open the door..."',
    sound: 'radioSound',
    choices: [
      { text: 'Obey the warning', next: 'scene1' },
      { text: 'Ignore and explore', next: 'scene_east' }
    ]
  },
